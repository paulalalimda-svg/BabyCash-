      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-baby-blue via-white to-baby-pink py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-2xl shadow-2xl">
          <div className="text-center">
            ...
            <h2 className="mt-6 text-3xl font-extrabold text-gray-900">¡Contraseña Actualizada!</h2>
      ...
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-2xl shadow-2xl">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="appearance-none block w-full px-3 py-3 border border-gray-300 rounded-lg placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-baby-blue focus:border-transparent transition-all text-center text-2xl tracking-widest font-mono"
                placeholder="000000"
              />
          ...
          <div className="space-y-3">
            <button
              type="submit"
              disabled={isLoading || newPassword !== confirmPassword || code.length !== 6}
